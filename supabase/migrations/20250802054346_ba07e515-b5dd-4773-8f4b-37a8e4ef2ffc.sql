-- CRITICAL SECURITY FIXES - Phase 1: RLS and Policy Updates (Final)
...
-- 6. Clean up duplicate emails and fix data integrity
-- Remove the incomplete email record
DELETE FROM public.registered 
WHERE email = 'mashaisharonmotsatsi@gmail' AND id = '5161f1eb-2516-4760-a119-40ccac934077';
